...
static PyObject *__pyx_pw_12hatshufflepy_1hat_shuffle_create_crs(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_crs_file)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("hat_shuffle_create_crs", 1, 2, 2, 1); __PYX_ERR(0, 3, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "hat_shuffle_create_crs") < 0)) __PYX_ERR(0, 3, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("hat_shuffle_create_crs", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 3, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 * 	hatshufflepy.create_crs(votes_number, crs_file)             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_votes_number); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L1_error)
  __pyx_t_2 = __pyx_convert_string_from_py_std__in_string(__pyx_v_crs_file); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L1_error)
 ...
 * 	hatshufflepy.create_crs(votes_number, crs_file)
 */
  __pyx_tuple_ = PyTuple_Pack(2, __pyx_n_s_votes_number, __pyx_n_s_crs_file); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(2, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_hatshufflepy_hatshufflepy_pyx, __pyx_n_s_hat_shuffle_create_crs, 3, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 * 	hatshufflepy.create_crs(votes_number, crs_file)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_12hatshufflepy_1hat_shuffle_create_crs, NULL, __pyx_n_s_hatshufflepy); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_hat_shuffle_create_crs, __pyx_t_1) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
