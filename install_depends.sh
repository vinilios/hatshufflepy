...
# Build and install
mkdir build; cd build && cmake .. -DCMAKE_INSTALL_PREFIX=../../hatshufflepy_dist/ -DCMAKE_INSTALL_RPATH="\$ORIGIN" -DDEBUG=ON -DCPPDEBUG=ON -DPROCPS_libprocps_VERSION=${PROCPS_VERSION:-3}
# Use multiple cores
